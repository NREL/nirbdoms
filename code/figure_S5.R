# supplementary S9- bdo at line pred vs measured
...
a <- tA_full_train %>% 
  ...
  ylim(-10,170)+
  xlim(-10,170)+
  labs(x="Predicted (g/L)", y = "Measured (g/L)", title = "Total BDO- Cross Validation", subtitle = "Laboratory at-line Full Model")+
  geom_abline()+
...
b <- tA_full_test %>% 
  ...
  ylim(-10,170)+
  xlim(-10,170)+
  labs(x="Predicted (g/L)", y = "Measured (g/L)", title = "Total BDO- Independent Validation", subtitle = "Laboratory at-line Full Model")+
  geom_abline()+
  geom_smooth(col = "black", method = "lm", se = FALSE)+
  stat_poly_eq( formula = y ~ x, aes(col = NULL, label = paste(..eq.label.., stat(rr.label), sep = "~~~")), parse = TRUE, size = 2)+
  theme(strip.background = element_rect(fill = "white", colour = "white"),
...
c <-  tA_full_indval %>% 
  ...
  labs(x="Predicted (g/L)", y = "Measured (g/L)", 
       title = "Total BDO- Unq Exp Validation",
...
d <- tA_nironefeasibility_train %>% 
  ...
  labs(x="Predicted (g/L)",
       y = "Measured (g/L)",
       title = "Total BDO- Cross Validation",
...
e <- tA_nironefeasibility_test %>% 
  ...
  ylim(-10,170)+
  xlim(-10,170)+
  labs(x="Predicted (g/L)", y = "Measured (g/L)", title = "Total BDO- Independent Validation", subtitle = "Laboratory at line low cost feasibility range model")+
  geom_abline()+
  geom_smooth(col = "black", method = "lm", se = FALSE)+
  stat_poly_eq( formula = y ~ x, aes(col = NULL, label = paste(..eq.label.., stat(rr.label), sep = "~~~")), parse = TRUE, size = 2)+
  theme(strip.background = element_rect(fill = "white",colour = "white"),
...
f <-  tA_nironefeasibility_indval %>% 
  ...
  scale_color_manual(values = c("Pure Sugar" = "#33a02c", "Feedstock Hydrolyzate" = "#1f78b4", "other" = "#a6cee3","unknown" = "#b2df8a"),
                     ...
                     drop = FALSE)+
  theme_bw()+
  coord_equal()+ylim(-10,170)+xlim(-10,170)+
  labs(x="Predicted (g/L)", y = "Measured (g/L)", title = "Total BDO- Unq Exp Validation", subtitle = "Laboratory at line low cost feasibility range model")+
  geom_abline()+
  geom_smooth(col = "black", method = "lm", se = FALSE)+
  stat_poly_eq( formula = y ~ x, aes(col = NULL, label = paste(..eq.label.., stat(rr.label), sep = "~~~")), parse = TRUE, size = 2)+
  theme(strip.background = element_rect(fill = "white", colour = "white"),
...
g <- nirone_train %>% 
  ...
  ylim(-10,170)+
  xlim(-10,170)+
  labs(x="Predicted (g/L)", y = "Measured (g/L)", title = "Total BDO- Cross Validation", subtitle = "Low cost at line Model")+
  geom_abline()+
  geom_smooth(col = "black", method = "lm", se = FALSE)+
  stat_poly_eq( formula = y ~ x, aes(col = NULL, label = paste(..eq.label.., stat(rr.label), sep = "~~~")), parse = TRUE, size = 2)+
  theme(strip.background = element_rect(fill = "white", colour = "white"), 
...
h <- nirone_test %>% 
  ...
  ylim(-10,170)+
  xlim(-10,170)+
  labs(x="Predicted (g/L)", y = "Measured (g/L)", title = "Total BDO- Independent Validation", subtitle = "Low cost at line Model")+
  geom_abline()+
  geom_smooth(col = "black", method = "lm", se = FALSE)+
  stat_poly_eq( formula = y ~ x, aes(col = NULL, label = paste(..eq.label.., stat(rr.label), sep = "~~~")), parse = TRUE, size = 2)+
  theme(strip.background = element_rect(fill = "white", colour = "white"),
...
i <-  nirone_indval %>% 
  ...
  ylim(-10,170)+
  xlim(-10,170)+
  labs(x="Predicted (g/L)", y = "Measured (g/L)", title = "Total BDO- Unq Exp Validation", subtitle = "Low cost at line Model")+
  geom_abline()+
  geom_smooth(col = "black", method = "lm", se = FALSE)+
  stat_poly_eq( formula = y ~ x, aes(col = NULL, label = paste(..eq.label.., stat(rr.label), sep = "~~~")), parse = TRUE, size = 2)+
  theme(strip.background = element_rect(fill = "white",colour = "white"),
...
ggsave("../figures/S5_bdoatlinepredvsmeasured_withfscolor.tiff", width  = 240,height =240 ,units = "mm", compression = "lzw")
