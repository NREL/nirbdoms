# building lab grade at line full model
...
indval$spec1 <- process_spectra_A_full(indval)
glucoseonly$spec1 <- process_spectra_A_full(glucoseonly)
...
saveRDS(PCs, "../data/processed/dataframes/laboratoryatline_full_PCs.RDS")

# save resulting predictions for each dataset (reclassify negative values as zero predictions)
...
training <- training %>% 
  ...
  mutate(model = "Laboratory At-Line Full")
...
saveRDS(fullmodel, "../data/processed/models/laboratoryatline_ringcup_fullmodel.RDS")
saveRDS(training, "../data/processed/dataframes/laboratoryatline_full_training.RDS")
saveRDS(testing, "../data/processed/dataframes/laboratoryatline_full_testing.RDS")
saveRDS(indval, "../data/processed/dataframes/laboratoryatline_full_indval.RDS")
saveRDS(glucoseonly, "../data/processed/dataframes/laboratoryatline_full_glucoseonly.RDS")
