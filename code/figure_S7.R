# supplementary S11- glycerol at line pred vs measured across at line datasets
...
# plot predicted vs measured by dataset, coloring by sugar source type
...
a <- tA_full_train %>% 
  ...
  ylim(-5,40)+
  xlim(-5,40)+
  labs(x="Predicted (g/L)", y = "Measured (g/L)", title = "Glycerol- Cross Validation", subtitle = "Laboratory at-line Full Model")+
  geom_abline()+
...
b <- tA_full_test %>% 
  ...
  ylim(-5,40)+
  xlim(-5,40)+
  labs(x="Predicted (g/L)", y = "Measured (g/L)", title = "Glycerol- Independent Validation", subtitle = "Laboratory at-line Full Model")+
  geom_abline()+
  geom_smooth(col = "black", method = "lm", se = FALSE)+
  stat_poly_eq( formula = y ~ x, aes(col = NULL, label = paste(..eq.label.., stat(rr.label), sep = "~~~")), parse = TRUE, size = 2)+
  theme(strip.background = element_rect(fill = "white", colour = "white"),
...
c <-  tA_full_indval %>% 
  ...
  labs(x="Predicted (g/L)", y = "Measured (g/L)", 
       title = "Glycerol- Unq Exp Validation",
...
d <- tA_nironefeasibility_train %>% 
  ...
  labs(x="Predicted (g/L)",
       y = "Measured (g/L)",
       title = "Glycerol- Cross Validation",
...
e <- tA_nironefeasibility_test %>% 
  ...
  ylim(-5,40)+
  xlim(-5,40)+
  labs(x="Predicted (g/L)", y = "Measured (g/L)", title = "Glycerol- Independent Validation", subtitle = "Laboratory at line low cost feasibility range model")+
  geom_abline()+
  geom_smooth(col = "black", method = "lm", se = FALSE)+
  stat_poly_eq( formula = y ~ x, aes(col = NULL, label = paste(..eq.label.., stat(rr.label), sep = "~~~")), parse = TRUE, size = 2)+
  theme(strip.background = element_rect(fill = "white",colour = "white"),
...
f <-  tA_nironefeasibility_indval %>% 
  ...
  ylim(-5,40)+
  xlim(-5,40)+
  labs(x="Predicted (g/L)", y = "Measured (g/L)", title = "Glycerol- Unq Exp Validation", subtitle = "Laboratory at line low cost feasibility range model")+
  geom_abline()+
  geom_smooth(col = "black", method = "lm", se = FALSE)+
  stat_poly_eq( formula = y ~ x, aes(col = NULL, label = paste(..eq.label.., stat(rr.label), sep = "~~~")), parse = TRUE, size = 2)+
  theme(strip.background = element_rect(fill = "white", colour = "white"),
...
g <- nirone_train %>% 
  ...
  ylim(-5,40)+
  xlim(-5,40)+
  labs(x="Predicted (g/L)", y = "Measured (g/L)", title = "Glycerol- Cross Validation", subtitle = "Low cost at line Model")+
  geom_abline()+
  geom_smooth(col = "black", method = "lm", se = FALSE)+
  stat_poly_eq( formula = y ~ x, aes(col = NULL, label = paste(..eq.label.., stat(rr.label), sep = "~~~")), parse = TRUE, size = 2)+
  theme(strip.background = element_rect(fill = "white", colour = "white"), 
...
h <- nirone_test %>% 
  ...
  ylim(-5,40)+
  xlim(-5,40)+
  labs(x="Predicted (g/L)", y = "Measured (g/L)", title = "Glycerol- Independent Validation", subtitle = "Low cost at line Model")+
  geom_abline()+
  geom_smooth(col = "black", method = "lm", se = FALSE)+
  stat_poly_eq( formula = y ~ x, aes(col = NULL, label = paste(..eq.label.., stat(rr.label), sep = "~~~")), parse = TRUE, size = 2)+
  theme(strip.background = element_rect(fill = "white", colour = "white"),
...
i <-  nirone_indval %>% 
  ...
  ylim(-5,40)+
  xlim(-5,40)+
  labs(x="Predicted (g/L)", y = "Measured (g/L)", title = "Glycerol- Unq Exp Validation", subtitle = "Low cost at line Model")+
  geom_abline()+
  geom_smooth(col = "black", method = "lm", se = FALSE)+
  stat_poly_eq( formula = y ~ x, aes(col = NULL, label = paste(..eq.label.., stat(rr.label), sep = "~~~")), parse = TRUE, size = 2)+
  theme(strip.background = element_rect(fill = "white",colour = "white"),
...
# combine all plots into one master plot
j <- ((a+b+c)/(d+e+f)/(g+h+i))
...
ggsave("../figures/S7_Glycerolatlinepredvsmeasured_withfscolor.tiff", width  = 240,height =240 ,units = "mm", compression = "lzw")
